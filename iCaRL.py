...
class iCaRLmodel:
    ...
    def afterTrain(self,accuracy):
        ...
        filename = 'CIFAR100_class=20_def/model/accuracy-%.3f_KNN_accuracy-%.3f_increment-%d_net.pkl' % (accuracy, KNN_accuracy, i + 10)  # changed : to -
        self.accuracy_list.append(KNN_accuracy)  #newly added
        filename2 = f'CIFAR100_class=20_def/class_means/model_class_mean_{self.task_num}.pth'  #newly added
