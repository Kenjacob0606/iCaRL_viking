...
#     filename = f'cifar100_class=5_def/model/task_{i}_training_time={task_end_time - task_start_time:.2f}_train={train_no}.txt'     #modify
#     torch.save((task_end_time - task_start_time), filename)
#     # if i==9:
# end_time = time.time()

# # print('Total training time: {:.2f} seconds'.format(end_time - start_time))
# filename2 = f'cifar100_class=5_def/model/total_training_time= {end_time - start_time:.2f}_train={train_no}.txt'        #modify
