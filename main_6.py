from iCaRL_6 import iCaRLmodel              #modify
...
filename2 = f'cifar100_lr=2.05_def/model/total_training_time= {end_time - start_time:.2f}_train={train_no}.txt'        #modify
